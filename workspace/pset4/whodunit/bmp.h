...
{ 
    WORD bfType; 
    DWORD bfSize; //contains total size of image including pixels and padding and headers 
    WORD bfReserved1; 
    WORD bfReserved2; 
    DWORD bfOffBits; 
...
{
    DWORD biSize; 
    LONG biWidth; //width of the image in pixels not including padding 
    LONG biHeight; //height of the image
    WORD biPlanes; 
    WORD biBitCount; 
    DWORD biCompression; 
    DWORD biSizeImage; //size of the image including padding pixel
